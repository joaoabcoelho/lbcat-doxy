...
151       \textcolor{keywordflow}{if}(\hyperlink{classAcquisition_ad323c9602565eec8e41f573d441745e2}{m\_chEnable}[c]>0)\{
152         \hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel}[c]=\hyperlink{classAcquisition_a76fe7c020f7097e5d479867ba783ba31}{decodeFormat}(c,d,\hyperlink{classAcquisition_a8a893e7485e96da01185df6d1109c0bc}{m\_fifo});
...
155           \hyperlink{classAcquisition_a8f0ef9898c1e63fb6f13c14508d3180d}{v}[c+8*d]+=\hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel}[c];
156           \hyperlink{classAcquisition_a841316dcf4f210ad52b144b187f2b7b6}{v2}[c+8*d]+=\hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel}[c]*\hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel}[c];
157         \}
158         \textcolor{keywordflow}{if} (\hyperlink{classAcquisition_a26d0f1a44309ffac49c365b7ee568ab2}{m\_nsample}==d)\{
159           \textcolor{keywordflow}{if} (\hyperlink{classAcquisition_a987cc1d04007cf1f5acc1accfd0909e5}{m\_store\_sample}) \hyperlink{classAcquisition_a53bcc000575de30eba6b7db8209be2cc}{m\_hsample}[c]->Fill(
      \hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel}[c]);
160         \}
161         nch++;
162       \}
163       c++;
164     \}
165     \textcolor{keywordflow}{if} (\hyperlink{classAcquisition_aca2143e9135e25554e58327475a767c5}{m\_store\_tree}) \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Fill();
166   \}
...
74     \hyperlink{classAcquisition_ad323c9602565eec8e41f573d441745e2}{m\_chEnable}[c]=0;
75     \hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel}[c]=-1;
...
81         \hyperlink{classAcquisition_a88963f722bfcde824882f6312a44e825}{m\_a}[c]=\textcolor{keyword}{new} TH1D(hname, title, \hyperlink{classAcquisition_a26628424533a2dd74d24712a14637a72}{m\_depth} , -0.5, (\textcolor{keywordtype}{float})(\hyperlink{classAcquisition_a26628424533a2dd74d24712a14637a72}{m\_depth})-0.5);
82         sprintf(hname,\textcolor{stringliteral}{"RMS\_Ch\_%1i"},c);
83         sprintf(title,\textcolor{stringliteral}{"RMS Ch %1i"},c);
84         \hyperlink{classAcquisition_a15d71455f658e21a12ef4c153c21df65}{m\_s}[c]=\textcolor{keyword}{new} TH1D(hname, title, \hyperlink{classAcquisition_a26628424533a2dd74d24712a14637a72}{m\_depth} , -0.5, (\textcolor{keywordtype}{float})(\hyperlink{classAcquisition_a26628424533a2dd74d24712a14637a72}{m\_depth})-0.5);
85         \hyperlink{classProcessus_ad46e0d4dfdfdcbce001ee6be1746dfa4}{addHisto1d}(\hyperlink{classAcquisition_a88963f722bfcde824882f6312a44e825}{m\_a}[c]);
86         \hyperlink{classProcessus_ad46e0d4dfdfdcbce001ee6be1746dfa4}{addHisto1d}(\hyperlink{classAcquisition_a15d71455f658e21a12ef4c153c21df65}{m\_s}[c]);
87       \}
...
91         \hyperlink{classAcquisition_a53bcc000575de30eba6b7db8209be2cc}{m\_hsample}[c]=\textcolor{keyword}{new} TH1D(hname, title, \hyperlink{classAcquisition_a05bccdc4b9ada37beaeba8794ccef12d}{m\_nbins}, \hyperlink{classAcquisition_a06b3ea027ebdcb15f64a6517ceb99b76}{m\_minRange}, 
      \hyperlink{classAcquisition_a45478629e9db582470b4b158edb46616}{m\_maxRange});
92         \hyperlink{classProcessus_ad46e0d4dfdfdcbce001ee6be1746dfa4}{addHisto1d}( \hyperlink{classAcquisition_a53bcc000575de30eba6b7db8209be2cc}{m\_hsample}[c] );
93       \}
94       \hyperlink{classAcquisition_ad323c9602565eec8e41f573d441745e2}{m\_chEnable}[c]=1;
...
103     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree} = \textcolor{keyword}{new} TTree(\textcolor{stringliteral}{"Acquisition"},\hyperlink{classObject_a300f4c05dd468c7bb8b3c968868443c1}{name}().c\_str());
104     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Branch(\textcolor{stringliteral}{"Run"},&\hyperlink{classAcquisition_afd35e220e0bfda7e763584524273aeb0}{m\_runNumber},\textcolor{stringliteral}{"Run/I"});
105     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Branch(\textcolor{stringliteral}{"Event"},&\hyperlink{classAcquisition_a32a70daa3f653eae5eafc46dbd0e11a6}{m\_evtNumber},\textcolor{stringliteral}{"Event/I"});
106     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Branch(\textcolor{stringliteral}{"Time"},&\hyperlink{classAcquisition_aa88cf8d27e075b5aaddb309dfb42cd04}{m\_timestamp},\textcolor{stringliteral}{"Time/D"});
107     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Branch(\textcolor{stringliteral}{"Sample"},&\hyperlink{classAcquisition_a154e5423720ab1f2c4ab5cd125cb4e80}{m\_sample},\textcolor{stringliteral}{"Sample/I"});
108     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Branch(\textcolor{stringliteral}{"Channel"},\hyperlink{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}{m\_channel},\textcolor{stringliteral}{"Channel[8]/I"});
109     \hyperlink{classAcquisition_a70f10db9c972f22a60bd2b82750168da}{m\_tree}->Branch(\textcolor{stringliteral}{"ChEnable"},\hyperlink{classAcquisition_ad323c9602565eec8e41f573d441745e2}{m\_chEnable},\textcolor{stringliteral}{"ChEnable[8]/I"});
110   \}
...
\subsubsection{\texorpdfstring{set\+Dead\+Time()}{setDeadTime()}}
...
\subsubsection{\texorpdfstring{set\+Store\+Tree()}{setStoreTree()}}
...
\mbox{\Hypertarget{classAcquisition_a88963f722bfcde824882f6312a44e825}\label{classAcquisition_a88963f722bfcde824882f6312a44e825}} 
...
\mbox{\Hypertarget{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}\label{classAcquisition_a1123502b520aec97ee8a71039abaa3fb}} 
...
\mbox{\Hypertarget{classAcquisition_ad323c9602565eec8e41f573d441745e2}\label{classAcquisition_ad323c9602565eec8e41f573d441745e2}} 
...
\mbox{\Hypertarget{classAcquisition_a7d95ba9a5593451a73754ed44f6bcd1c}\label{classAcquisition_a7d95ba9a5593451a73754ed44f6bcd1c}} 
...
\mbox{\Hypertarget{classAcquisition_a53bcc000575de30eba6b7db8209be2cc}\label{classAcquisition_a53bcc000575de30eba6b7db8209be2cc}} 
...
\mbox{\Hypertarget{classAcquisition_a15d71455f658e21a12ef4c153c21df65}\label{classAcquisition_a15d71455f658e21a12ef4c153c21df65}} 
...
\mbox{\Hypertarget{classAcquisition_a70f10db9c972f22a60bd2b82750168da}\label{classAcquisition_a70f10db9c972f22a60bd2b82750168da}} 
...
\mbox{\Hypertarget{classAcquisition_a8f0ef9898c1e63fb6f13c14508d3180d}\label{classAcquisition_a8f0ef9898c1e63fb6f13c14508d3180d}} 
...
\mbox{\Hypertarget{classAcquisition_a841316dcf4f210ad52b144b187f2b7b6}\label{classAcquisition_a841316dcf4f210ad52b144b187f2b7b6}} 
