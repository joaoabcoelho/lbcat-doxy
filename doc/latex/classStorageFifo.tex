\hypertarget{classStorageFifo}{
\section{StorageFifo Class Reference}
\label{classStorageFifo}\index{StorageFifo@{StorageFifo}}
}


{\ttfamily \#include $<$inc/StorageFifo.h$>$}Inheritance diagram for StorageFifo::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=4cm]{classStorageFifo}
\end{center}
\end{figure}
\subsection*{Classes}
\begin{DoxyCompactItemize}
\item 
class \hyperlink{classStorageFifo_1_1StorageFifo}{StorageFifo}
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classStorageFifo_a223700b2d5de3bd59ccf76df29f979d3}{StorageFifo} ()
\begin{DoxyCompactList}\small\item\em Standard constructor. \item\end{DoxyCompactList}\item 
virtual \hyperlink{classStorageFifo_a5c464d5913f8857b54462f982bfa8ea3}{$\sim$StorageFifo} ()
\begin{DoxyCompactList}\small\item\em Destructor. \item\end{DoxyCompactList}\item 
virtual \hyperlink{classStatusCode}{StatusCode} \hyperlink{classStorageFifo_a568becd5cb8d0cb5307a39e0d27fb332}{initialize} ()
\item 
virtual \hyperlink{classStatusCode}{StatusCode} \hyperlink{classStorageFifo_aa6826007c79ce353640fd1b1836807ff}{execute} ()
\item 
virtual \hyperlink{classStatusCode}{StatusCode} \hyperlink{classStorageFifo_aaa04959087ffc774dbb713f9910c6c04}{finalize} ()
\item 
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classStorageFifo_1_1StorageFifo}{StorageFifo} $\ast$ \hyperlink{classStorageFifo_a80b534eb6d81a3b570f6957d6a932987}{clone} ()
\end{DoxyCompactItemize}
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classProto40MHz__v1}{Proto40MHz\_\-v1} $\ast$ \hyperlink{classStorageFifo_adca2141575d4994ef13e3dabe2e06c52}{m\_\-board}
\item 
\hyperlink{classA3PE}{A3PE} $\ast$ \hyperlink{classStorageFifo_a9e4b9d56d0cc911f124a2848d6b43981}{m\_\-pga}
\item 
\hyperlink{classRAM}{RAM} $\ast$ \hyperlink{classStorageFifo_a4b1f3eb44df4f2d46a8a62189d662390}{m\_\-fifo}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_abe762844e442bc8188643b18b276d801}{m\_\-h1}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_a3caf6211541aaa4be8e60c03d79bf253}{m\_\-h2}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_a7e6b54c96a9b53a9917f7f21bda12b2e}{m\_\-h3}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_ad026ffc1c7590bb3563538490be9aa00}{m\_\-h4}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_ae9133c5421f9fa166b837933706d2a59}{m\_\-h5}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_a39ca376b2a74643c54e4df2dfabf0906}{m\_\-h6}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_a01784ff4138a1b32eb517931b5866cc6}{m\_\-h7}
\item 
TH1D $\ast$ \hyperlink{classStorageFifo_aeef4b7183e14d05bab673d948d85b84c}{m\_\-h8}
\item 
...
\index{StorageFifo@{StorageFifo}!Attribut@{Attribut}}
\index{Attribut@{Attribut}!StorageFifo@{StorageFifo}}
...
\item[Enumerator: ]\par
\begin{description}
\index{UNDEFINED@{UNDEFINED}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!UNDEFINED@{UNDEFINED}}\item[{\em 
...
}]\index{PASSIVE@{PASSIVE}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!PASSIVE@{PASSIVE}}\item[{\em 
...
}]\index{ACTIVE@{ACTIVE}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!ACTIVE@{ACTIVE}}\item[{\em 
...
}]\index{INTERFACE@{INTERFACE}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!INTERFACE@{INTERFACE}}\item[{\em 
...
}]\index{IO@{IO}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!IO@{IO}}\item[{\em 
...
}]\index{IODATA@{IODATA}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!IODATA@{IODATA}}\item[{\em 
...
}]\index{ELEMENT@{ELEMENT}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!ELEMENT@{ELEMENT}}\item[{\em 
...
}]\index{HARDWARE@{HARDWARE}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!HARDWARE@{HARDWARE}}\item[{\em 
...
}]\index{PROCESSUS@{PROCESSUS}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!PROCESSUS@{PROCESSUS}}\item[{\em 
...
}]\index{SOFTWARE@{SOFTWARE}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!SOFTWARE@{SOFTWARE}}\item[{\em 
...
\index{StorageFifo@{StorageFifo}!states@{states}}
\index{states@{states}!StorageFifo@{StorageFifo}}
...
\item[Enumerator: ]\par
\begin{description}
\index{ERR@{ERR}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!ERR@{ERR}}\item[{\em 
...
}]\index{NOT\_\-OK@{NOT\_\-OK}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!NOT\_\-OK@{NOT\_\-OK}}\item[{\em 
...
}]\index{OK@{OK}!StorageFifo@{StorageFifo}}\index{StorageFifo@{StorageFifo}!OK@{OK}}\item[{\em 
...
\hypertarget{classStorageFifo_a223700b2d5de3bd59ccf76df29f979d3}{
\index{StorageFifo@{StorageFifo}!StorageFifo@{StorageFifo}}
\index{StorageFifo@{StorageFifo}!StorageFifo@{StorageFifo}}
\subsubsection[{StorageFifo}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StorageFifo::StorageFifo} ()}}
\label{classStorageFifo_a223700b2d5de3bd59ccf76df29f979d3}
...
//=============================================================================
\end{DoxyCode}
\hypertarget{classStorageFifo_a5c464d5913f8857b54462f982bfa8ea3}{
\index{StorageFifo@{StorageFifo}!$\sim$StorageFifo@{$\sim$StorageFifo}}
\index{$\sim$StorageFifo@{$\sim$StorageFifo}!StorageFifo@{StorageFifo}}
\subsubsection[{$\sim$StorageFifo}]{\setlength{\rightskip}{0pt plus 5cm}StorageFifo::$\sim$StorageFifo ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classStorageFifo_a5c464d5913f8857b54462f982bfa8ea3}
...
\index{StorageFifo@{StorageFifo}!add@{add}}
\index{add@{add}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!addDataStream@{addDataStream}}
\index{addDataStream@{addDataStream}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!addHisto1d@{addHisto1d}}
\index{addHisto1d@{addHisto1d}!StorageFifo@{StorageFifo}}
...
Referenced by TestSuite::initialize(), StorageFifoAcquisition::initialize(), initialize(), Acquisition::initialize(), and A3PE\_\-BitFlip::initialize().
...
\index{StorageFifo@{StorageFifo}!addHisto2d@{addHisto2d}}
\index{addHisto2d@{addHisto2d}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!attributs@{attributs}}
\index{attributs@{attributs}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!clean@{clean}}
\index{clean@{clean}!StorageFifo@{StorageFifo}}
...
99   }
\end{DoxyCode}
\hypertarget{classStorageFifo_a80b534eb6d81a3b570f6957d6a932987}{
\index{StorageFifo@{StorageFifo}!clone@{clone}}
\index{clone@{clone}!StorageFifo@{StorageFifo}}
\subsubsection[{clone}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StorageFifo}$\ast$ StorageFifo::clone ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, protected, virtual\mbox{]}}}}
\label{classStorageFifo_a80b534eb6d81a3b570f6957d6a932987}
...
\index{StorageFifo@{StorageFifo}!closeRootFile@{closeRootFile}}
\index{closeRootFile@{closeRootFile}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!data@{data}}
\index{data@{data}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!dataFill@{dataFill}}
\index{dataFill@{dataFill}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!debug@{debug}}
\index{debug@{debug}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!dllName@{dllName}}
\index{dllName@{dllName}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!elapsedTime@{elapsedTime}}
\index{elapsedTime@{elapsedTime}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!element@{element}}
\index{element@{element}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!endProcessing@{endProcessing}}
\index{endProcessing@{endProcessing}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!error@{error}}
\index{error@{error}!StorageFifo@{StorageFifo}}
...
\end{DoxyCode}
\hypertarget{classStorageFifo_aa6826007c79ce353640fd1b1836807ff}{
\index{StorageFifo@{StorageFifo}!execute@{execute}}
\index{execute@{execute}!StorageFifo@{StorageFifo}}
\subsubsection[{execute}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} StorageFifo::execute ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classStorageFifo_aa6826007c79ce353640fd1b1836807ff}
...
References A3PE::acquisition(), IOdata::dataU8(), Object::debug(), IOobject::io(), m\_\-depth, m\_\-fifo, m\_\-h1, m\_\-h2, m\_\-h3, m\_\-h4, m\_\-h5, m\_\-h6, m\_\-h7, m\_\-h8, m\_\-pga, IOobject::read(), and StatusCode::SUCCESS.
...
\index{StorageFifo@{StorageFifo}!fatal@{fatal}}
\index{fatal@{fatal}!StorageFifo@{StorageFifo}}
...
\end{DoxyCode}
\hypertarget{classStorageFifo_aaa04959087ffc774dbb713f9910c6c04}{
\index{StorageFifo@{StorageFifo}!finalize@{finalize}}
\index{finalize@{finalize}!StorageFifo@{StorageFifo}}
\subsubsection[{finalize}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} StorageFifo::finalize ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classStorageFifo_aaa04959087ffc774dbb713f9910c6c04}
processus termination virtual function 
...
\index{StorageFifo@{StorageFifo}!hist1d@{hist1d}}
\index{hist1d@{hist1d}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!hist2d@{hist2d}}
\index{hist2d@{hist2d}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!id@{id}}
\index{id@{id}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!incNErrors@{incNErrors}}
\index{incNErrors@{incNErrors}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!info@{info}}
\index{info@{info}!StorageFifo@{StorageFifo}}
...
\end{DoxyCode}
\hypertarget{classStorageFifo_a568becd5cb8d0cb5307a39e0d27fb332}{
\index{StorageFifo@{StorageFifo}!initialize@{initialize}}
\index{initialize@{initialize}!StorageFifo@{StorageFifo}}
\subsubsection[{initialize}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} StorageFifo::initialize ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classStorageFifo_a568becd5cb8d0cb5307a39e0d27fb332}
...
References Proto40MHz\_\-v1::a3pe(), Processus::addHisto1d(), Object::debug(), Processus::element(), A3PE::fifoDepth(), Object::info(), m\_\-board, m\_\-depth, m\_\-fifo, m\_\-h1, m\_\-h2, m\_\-h3, m\_\-h4, m\_\-h5, m\_\-h6, m\_\-h7, m\_\-h8, m\_\-pga, Object::name(), A3PE::setEnableADC(), A3PE::setSoftwareTrigger(), A3PE::setWriteStorageFifoUsb(), A3PE::storageRam(), StatusCode::SUCCESS, Object::type(), and Object::warning().
...
61   m_pga->setSoftwareTrigger(true);
62   m_pga->setWriteStorageFifoUsb(false);
63   
64   m_fifo = m_pga->storageRam();
65   
66   for (int i=0; i<8; ++i) m_pga->setEnableADC(i,true);
67   
68   m_depth=m_pga->fifoDepth();
69   
70   m_h1=new TH1D( "Channel1" , "Data values channel 1" , m_depth , 0. , float(
      m_depth) );
71   m_h2=new TH1D( "Channel2" , "Data values channel 2" , m_depth , 0. , float(
      m_depth) );
72   m_h3=new TH1D( "Channel3" , "Data values channel 3" , m_depth , 0. , float(
      m_depth) );
73   m_h4=new TH1D( "Channel4" , "Data values channel 4" , m_depth , 0. , float(
      m_depth) );
74   m_h5=new TH1D( "Channel5",  "Data values channel 5" , m_depth , 0. , float(
      m_depth) );
75   m_h6=new TH1D( "Channel6" , "Data values channel 6" , m_depth , 0. , float(
      m_depth) );
76   m_h7=new TH1D( "Channel7" , "Data values channel 7" , m_depth , 0. , float(
      m_depth) );
77   m_h8=new TH1D( "Channel8" , "Data values channel 8" , m_depth , 0. , float(
      m_depth) );
78   addHisto1d( m_h1 );
79   addHisto1d( m_h2 );
80   addHisto1d( m_h3 );
...
\index{StorageFifo@{StorageFifo}!is@{is}}
\index{is@{is}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!logMsg@{logMsg}}
\index{logMsg@{logMsg}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!msg@{msg}}
\index{msg@{msg}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!msgSvc@{msgSvc}}
\index{msgSvc@{msgSvc}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!name@{name}}
\index{name@{name}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!nErrors@{nErrors}}
\index{nErrors@{nErrors}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!openRootFile@{openRootFile}}
\index{openRootFile@{openRootFile}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!remove@{remove}}
\index{remove@{remove}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!rootFile@{rootFile}}
\index{rootFile@{rootFile}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setDllName@{setDllName}}
\index{setDllName@{setDllName}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setElement@{setElement}}
\index{setElement@{setElement}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setId@{setId}}
\index{setId@{setId}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setLogMsg@{setLogMsg}}
\index{setLogMsg@{setLogMsg}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setName@{setName}}
\index{setName@{setName}!StorageFifo@{StorageFifo}}
...
Referenced by A3PE::A3PE(), A3PE\_\-BitFlip::A3PE\_\-BitFlip(), Acquisition::Acquisition(), ADCMeasurement::ADCMeasurement(), Computer::Computer(), Application::create(), Croc::Croc(), CU\_\-v1::CU\_\-v1(), CurrentMeasurement::CurrentMeasurement(), EmulateFE::EmulateFE(), export\_\-obj(), FEB\_\-v1::FEB\_\-v1(), FePGA::FePGA(), ICECALv3::ICECALv3(), ICPhaser::ICPhaser(), Application::initialize(), Interface::Interface(), IOdata::IOdata(), IOobject::IOobject(), LSDelayChipV1::LSDelayChipV1(), FePGA::MakeRAM(), FePGA::MakeRegister(), Application::network(), NI6008::NI6008(), Object::Object(), PhaserRampExec::PhaserRampExec(), Proto40MHz\_\-v1::Proto40MHz\_\-v1(), RAM::RAM(), Register::Register(), RegisterTest::RegisterTest(), SeqPGA::SeqPGA(), SpecsBus::SpecsBus(), SpecsGlue::SpecsGlue(), SpecsI2c::SpecsI2c(), SpecsMaster::SpecsMaster(), SpecsMezzanine::SpecsMezzanine(), SpecsParallelBus::SpecsParallelBus(), StorageFifo(), StorageFifoAcquisition::StorageFifoAcquisition(), TestI2C::TestI2C(), TestSPI::TestSPI(), TestSuite::TestSuite(), TestUSB::TestUSB(), UsbFTInterface::UsbFTInterface(), UsbFTInterfaceTest::UsbFTInterfaceTest(), UsbFTMLInterface::UsbFTMLInterface(), UsbI2cBus::UsbI2cBus(), UsbMLI2cBus::UsbMLI2cBus(), UsbMLSpiBus::UsbMLSpiBus(), and UsbSpiBus::UsbSpiBus().
...
\index{StorageFifo@{StorageFifo}!setNErrors@{setNErrors}}
\index{setNErrors@{setNErrors}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setState@{setState}}
\index{setState@{setState}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setStorage@{setStorage}}
\index{setStorage@{setStorage}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!setTitle@{setTitle}}
\index{setTitle@{setTitle}!StorageFifo@{StorageFifo}}
...
Referenced by A3PE\_\-BitFlip::A3PE\_\-BitFlip(), Acquisition::Acquisition(), ADCMeasurement::ADCMeasurement(), CurrentMeasurement::CurrentMeasurement(), EmulateFE::EmulateFE(), export\_\-obj(), Histo1D::Histo1D(), Histo2D::Histo2D(), Object::Object(), PhaserRampExec::PhaserRampExec(), RegisterTest::RegisterTest(), StorageFifo(), StorageFifoAcquisition::StorageFifoAcquisition(), TestI2C::TestI2C(), TestSPI::TestSPI(), TestSuite::TestSuite(), TestUSB::TestUSB(), and UsbFTInterfaceTest::UsbFTInterfaceTest().
...
\index{StorageFifo@{StorageFifo}!setType@{setType}}
\index{setType@{setType}!StorageFifo@{StorageFifo}}
...
Referenced by A3PE::A3PE(), A3PE\_\-BitFlip::A3PE\_\-BitFlip(), Acquisition::Acquisition(), ADCMeasurement::ADCMeasurement(), Computer::Computer(), Croc::Croc(), CU\_\-v1::CU\_\-v1(), CurrentMeasurement::CurrentMeasurement(), DCU::DCU(), EmulateFE::EmulateFE(), export\_\-obj(), FEB\_\-v1::FEB\_\-v1(), FePGA::FePGA(), ICECALv3::ICECALv3(), ICPhaser::ICPhaser(), Application::initialize(), Interface::Interface(), IOdata::IOdata(), IOobject::IOobject(), LSDelayChipV1::LSDelayChipV1(), MSOxxxx::MSOxxxx(), NI6008::NI6008(), Object::Object(), Phaser::Phaser(), PhaserRampExec::PhaserRampExec(), Proto40MHz\_\-v1::Proto40MHz\_\-v1(), RAM::RAM(), Register::Register(), RegisterTest::RegisterTest(), SeqPGA::SeqPGA(), SpecsBus::SpecsBus(), SpecsGlue::SpecsGlue(), SpecsI2c::SpecsI2c(), SpecsMaster::SpecsMaster(), SpecsMezzanine::SpecsMezzanine(), SpecsParallelBus::SpecsParallelBus(), SpecsSlave::SpecsSlave(), StorageFifo(), StorageFifoAcquisition::StorageFifoAcquisition(), TestI2C::TestI2C(), TestSPI::TestSPI(), TestSuite::TestSuite(), TestUSB::TestUSB(), UsbFTInterface::UsbFTInterface(), UsbFTInterfaceTest::UsbFTInterfaceTest(), UsbFTMLInterface::UsbFTMLInterface(), UsbI2cBus::UsbI2cBus(), UsbMLI2cBus::UsbMLI2cBus(), UsbMLSpiBus::UsbMLSpiBus(), and UsbSpiBus::UsbSpiBus().
...
\index{StorageFifo@{StorageFifo}!startChrono@{startChrono}}
\index{startChrono@{startChrono}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!startProcessing@{startProcessing}}
\index{startProcessing@{startProcessing}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!storage@{storage}}
\index{storage@{storage}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!title@{title}}
\index{title@{title}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!type@{type}}
\index{type@{type}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!verbose@{verbose}}
\index{verbose@{verbose}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!warning@{warning}}
\index{warning@{warning}!StorageFifo@{StorageFifo}}
...
\index{StorageFifo@{StorageFifo}!m\_\-attribString@{m\_\-attribString}}
\index{m\_\-attribString@{m\_\-attribString}!StorageFifo@{StorageFifo}}
...
Referenced by Attrib::Attrib(), and Attrib::attributs().\hypertarget{classStorageFifo_adca2141575d4994ef13e3dabe2e06c52}{
\index{StorageFifo@{StorageFifo}!m\_\-board@{m\_\-board}}
\index{m\_\-board@{m\_\-board}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-board}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Proto40MHz\_\-v1}$\ast$ {\bf StorageFifo::m\_\-board}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_adca2141575d4994ef13e3dabe2e06c52}


Definition at line 34 of file StorageFifo.h.

Referenced by initialize().\hypertarget{classStorageFifo_a4312878a2a96e6a306be9e5fd99064d5}{
\index{StorageFifo@{StorageFifo}!m\_\-depth@{m\_\-depth}}
\index{m\_\-depth@{m\_\-depth}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-depth}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf StorageFifo::m\_\-depth}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a4312878a2a96e6a306be9e5fd99064d5}
...
\index{StorageFifo@{StorageFifo}!m\_\-element@{m\_\-element}}
\index{m\_\-element@{m\_\-element}!StorageFifo@{StorageFifo}}
...
Referenced by Processus::clean(), Processus::element(), Processus::setElement(), and Processus::$\sim$Processus().\hypertarget{classStorageFifo_a4b1f3eb44df4f2d46a8a62189d662390}{
\index{StorageFifo@{StorageFifo}!m\_\-fifo@{m\_\-fifo}}
\index{m\_\-fifo@{m\_\-fifo}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-fifo}]{\setlength{\rightskip}{0pt plus 5cm}{\bf RAM}$\ast$ {\bf StorageFifo::m\_\-fifo}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a4b1f3eb44df4f2d46a8a62189d662390}


Definition at line 36 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_abe762844e442bc8188643b18b276d801}{
\index{StorageFifo@{StorageFifo}!m\_\-h1@{m\_\-h1}}
\index{m\_\-h1@{m\_\-h1}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h1}]{\setlength{\rightskip}{0pt plus 5cm}TH1D$\ast$ {\bf StorageFifo::m\_\-h1}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_abe762844e442bc8188643b18b276d801}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_a3caf6211541aaa4be8e60c03d79bf253}{
\index{StorageFifo@{StorageFifo}!m\_\-h2@{m\_\-h2}}
\index{m\_\-h2@{m\_\-h2}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h2}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h2}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a3caf6211541aaa4be8e60c03d79bf253}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_a7e6b54c96a9b53a9917f7f21bda12b2e}{
\index{StorageFifo@{StorageFifo}!m\_\-h3@{m\_\-h3}}
\index{m\_\-h3@{m\_\-h3}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h3}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h3}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a7e6b54c96a9b53a9917f7f21bda12b2e}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_ad026ffc1c7590bb3563538490be9aa00}{
\index{StorageFifo@{StorageFifo}!m\_\-h4@{m\_\-h4}}
\index{m\_\-h4@{m\_\-h4}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h4}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h4}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_ad026ffc1c7590bb3563538490be9aa00}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_ae9133c5421f9fa166b837933706d2a59}{
\index{StorageFifo@{StorageFifo}!m\_\-h5@{m\_\-h5}}
\index{m\_\-h5@{m\_\-h5}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h5}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h5}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_ae9133c5421f9fa166b837933706d2a59}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_a39ca376b2a74643c54e4df2dfabf0906}{
\index{StorageFifo@{StorageFifo}!m\_\-h6@{m\_\-h6}}
\index{m\_\-h6@{m\_\-h6}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h6}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h6}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a39ca376b2a74643c54e4df2dfabf0906}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_a01784ff4138a1b32eb517931b5866cc6}{
\index{StorageFifo@{StorageFifo}!m\_\-h7@{m\_\-h7}}
\index{m\_\-h7@{m\_\-h7}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h7}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h7}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a01784ff4138a1b32eb517931b5866cc6}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_aeef4b7183e14d05bab673d948d85b84c}{
\index{StorageFifo@{StorageFifo}!m\_\-h8@{m\_\-h8}}
\index{m\_\-h8@{m\_\-h8}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-h8}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf StorageFifo::m\_\-h8}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_aeef4b7183e14d05bab673d948d85b84c}


Definition at line 37 of file StorageFifo.h.

Referenced by execute(), and initialize().\hypertarget{classStorageFifo_a9e4b9d56d0cc911f124a2848d6b43981}{
\index{StorageFifo@{StorageFifo}!m\_\-pga@{m\_\-pga}}
\index{m\_\-pga@{m\_\-pga}!StorageFifo@{StorageFifo}}
\subsubsection[{m\_\-pga}]{\setlength{\rightskip}{0pt plus 5cm}{\bf A3PE}$\ast$ {\bf StorageFifo::m\_\-pga}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classStorageFifo_a9e4b9d56d0cc911f124a2848d6b43981}
...
\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatCaloProto40MHz/inc/proc/\hyperlink{StorageFifo_8h}{StorageFifo.h}\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatCaloProto40MHz/src/proc/\hyperlink{StorageFifo_8cpp}{StorageFifo.cpp}\end{DoxyCompactItemize}
