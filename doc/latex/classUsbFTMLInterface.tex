...
743   \hyperlink{classStatusCode}{StatusCode} status;
744   \textcolor{keywordflow}{switch} (io->\hyperlink{classIOdata_a91f9e8b4095ca8365a824e43be36b143}{wordSize}())
745   \{
746   \textcolor{keywordflow}{case} (\hyperlink{classIOdata_a37c53ebf4bf8d866aac8af572962a84ca00156611f08eeb1b5d361de809dafb8e}{IOdata::Byte}):
747     \textcolor{keywordflow}{if} (nWords<\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax}+1)\{
748       \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"Reading a single block "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(nWords)+\textcolor{stringliteral}{"/"}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(
      \hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax}),
749               \textcolor{stringliteral}{"UsbFTMLInterface::read"});
750       status = \hyperlink{classUsbFTMLInterface_ac356419a8bbaa26e63f182a86e5fd380}{usbReadU8}( address, nWords, io->\hyperlink{classIOdata_a75e9c318dbac3a39402179070943d4bc}{dataU8}());        
751     \}
752     \textcolor{keywordflow}{else} \{
753       \textcolor{comment}{//      int nwords=nWords;}
754       \hyperlink{ICECALv3_8h_a3cb25ca6f51f003950f9625ff05536fc}{U8}* \hyperlink{namespaceshell_a5ea2525995cedc3efd69ea8a7f034d1e}{data}=io->\hyperlink{classIOdata_a75e9c318dbac3a39402179070943d4bc}{dataU8}();
755       \textcolor{keywordtype}{int} nXfer=(int)(nWords/\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax})+1;
756       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<nXfer ; ++i)\{
757         \textcolor{keywordflow}{if} (i<nXfer-1)\{
758           \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"Reading block "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(i)+
759                   \textcolor{stringliteral}{" of size "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax}),
760                   \textcolor{stringliteral}{"UsbFTMLInterface::read"});
761           status = \hyperlink{classUsbFTMLInterface_ac356419a8bbaa26e63f182a86e5fd380}{usbReadU8}( address, 
762                               \hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax} , 
763                               data);
764           data+=\textcolor{keyword}{sizeof}(\hyperlink{ICECALv3_8h_a3cb25ca6f51f003950f9625ff05536fc}{U8}*)*\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax};
765         \}
766         \textcolor{keywordflow}{else} \{
767           \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"Reading last block "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(i)+
768                   \textcolor{stringliteral}{" of size "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(nWords%\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax}),
769                   \textcolor{stringliteral}{"UsbFTMLInterface::read"});
770           status = \hyperlink{classUsbFTMLInterface_ac356419a8bbaa26e63f182a86e5fd380}{usbReadU8}( address, 
771                               nWords%\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax} , 
772                               data); 
773           data+=\textcolor{keyword}{sizeof}(\hyperlink{ICECALv3_8h_a3cb25ca6f51f003950f9625ff05536fc}{U8}*)*(nWords%\hyperlink{classUsbFTMLInterface_af950506bbfb1e198af7ea2141058d018}{m\_rdBlockMax});
774         \}
775       \}
776     \}
777     \textcolor{keywordflow}{break};
778   \textcolor{keywordflow}{case} (\hyperlink{classIOdata_a37c53ebf4bf8d866aac8af572962a84ca7d603e9c9a55e3c8dffa4bd8e3dca491}{IOdata::Word}):
779     status = \hyperlink{classUsbFTMLInterface_a5fb608bce418671265b61266033cedc0}{usbReadU16}( address, nWords, io->\hyperlink{classIOdata_a8d8528b731c6cf117f8c5b9b2473390c}{dataU16}());
780     \textcolor{keywordflow}{break};
781   \textcolor{keywordflow}{case} (\hyperlink{classIOdata_a37c53ebf4bf8d866aac8af572962a84ca458da82d97e3ea9715c34b558c34f734}{IOdata::DWord}):
782     status = \hyperlink{classUsbFTMLInterface_aa1256fc56698bc9ed1bcf11ecc6ff766}{usbReadU32}( address, nWords, io->\hyperlink{classIOdata_ab0e3cd09f46c1c3712f797116f6da074}{dataU32}());
783     \textcolor{keywordflow}{break};
784   \textcolor{keywordflow}{default}:
785     \hyperlink{classObject_a204a95f57818c0f811933917a30eff45}{error}(\textcolor{stringliteral}{"Wrong word size."},\textcolor{stringliteral}{"UsbFTMLInterface::read"});
786     status=\hyperlink{classStatusCode_a6f565cbeadc76d14c72f047e5e85eb4ba3da73d4c469762eb9d3c960368252b26}{StatusCode::FAILURE};
787   \}
788   \textcolor{keywordflow}{return} status;
789 \}
\end{DoxyCode}
...
794                                             \{
795 
796   \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} address = io->\hyperlink{classIOdata_afe410c86881b8c2082a08e5ce9843306}{address}();
797   \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} nWords  = io->\hyperlink{classIOdata_abb40e71ce0290832a24857b4a1e7b1a3}{length}();
798   \hyperlink{classStatusCode}{StatusCode} status;
799   \textcolor{keywordflow}{switch} (io->\hyperlink{classIOdata_a91f9e8b4095ca8365a824e43be36b143}{wordSize}())
800   \{
801   \textcolor{keywordflow}{case} (\hyperlink{classIOdata_a37c53ebf4bf8d866aac8af572962a84ca00156611f08eeb1b5d361de809dafb8e}{IOdata::Byte}):
802     \textcolor{keywordflow}{if} (nWords<\hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax}+1)\{
803       \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"Writing a single block "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(nWords)+\textcolor{stringliteral}{"/"}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(
      \hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax}),
804               \textcolor{stringliteral}{"UsbFTMLInterface::write"});
805       status = \hyperlink{classUsbFTMLInterface_ae5cb7b250be9be23f90f455f57d41287}{usbWriteU8}(address, nWords, io->\hyperlink{classIOdata_a75e9c318dbac3a39402179070943d4bc}{dataU8}());
806     \}
807     \textcolor{keywordflow}{else} \{
808       \textcolor{comment}{//      int nwords=nWords;}
809       \hyperlink{ICECALv3_8h_a3cb25ca6f51f003950f9625ff05536fc}{U8}* \hyperlink{namespaceshell_a5ea2525995cedc3efd69ea8a7f034d1e}{data}=io->\hyperlink{classIOdata_a75e9c318dbac3a39402179070943d4bc}{dataU8}();
810       \textcolor{keywordtype}{int} nXfer=(int)ceil((\textcolor{keywordtype}{float})(nWords)/(\textcolor{keywordtype}{float})(\hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax}));
811       \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"number of Xfer="}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(nXfer)+
812               \textcolor{stringliteral}{" "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(\hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax})+
813               \textcolor{stringliteral}{" "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(nWords),\textcolor{stringliteral}{""});
814       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<nXfer ; ++i)\{
815         \textcolor{keywordflow}{if} (i<nXfer-1)\{
816           \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"Writing block "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(i)+
817                   \textcolor{stringliteral}{" of size "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(\hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax}),
818                   \textcolor{stringliteral}{"UsbFTMLInterface::write"});
819           status = \hyperlink{classUsbFTMLInterface_ae5cb7b250be9be23f90f455f57d41287}{usbWriteU8}( address, 
820                                \hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax} , 
821                                data);
822           data+=\textcolor{keyword}{sizeof}(\hyperlink{classUsbFTMLInterface_af7c9f02ee6f59fefa68ef14f90dcbbd8}{U8})*\hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax};
823         \}
824         \textcolor{keywordflow}{else} \{
825           \textcolor{comment}{//nWords%m\_wrBlockMax}
826           \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} nwords=nWords-(nXfer-1)*\hyperlink{classUsbFTMLInterface_adb3d6b099e8283d80360f78fab064285}{m\_wrBlockMax};
827           \hyperlink{classObject_a83d2db2df682907ea1115ad721c1c4a1}{verbose}(\textcolor{stringliteral}{"Writing last block "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(i)+
828                   \textcolor{stringliteral}{" of size "}+\hyperlink{Tools_8h_af330027dbdafb9a30768b3613c553e60}{itos}(nwords),
829                   \textcolor{stringliteral}{"UsbFTMLInterface::write"});
830           status = \hyperlink{classUsbFTMLInterface_ae5cb7b250be9be23f90f455f57d41287}{usbWriteU8}( address, 
831                                nwords, 
832                                data); 
833           data+=\textcolor{keyword}{sizeof}(\hyperlink{classUsbFTMLInterface_af7c9f02ee6f59fefa68ef14f90dcbbd8}{U8})*(nwords);
834         \}
835       \}
836     \}
837     \textcolor{keywordflow}{break};
838   \textcolor{keywordflow}{case} (\hyperlink{classIOdata_a37c53ebf4bf8d866aac8af572962a84ca7d603e9c9a55e3c8dffa4bd8e3dca491}{IOdata::Word}):
839     status = \hyperlink{classUsbFTMLInterface_ab5c7e059f621774c6f51a1a7e9012aed}{usbWriteU16}(address, nWords, io->\hyperlink{classIOdata_a8d8528b731c6cf117f8c5b9b2473390c}{dataU16}());
840     \textcolor{keywordflow}{break};
841   \textcolor{keywordflow}{case} (\hyperlink{classIOdata_a37c53ebf4bf8d866aac8af572962a84ca458da82d97e3ea9715c34b558c34f734}{IOdata::DWord}):
842     status = \hyperlink{classUsbFTMLInterface_a79433fc9a3dd8c96519960cd55958fbf}{usbWriteU32}(address, nWords, io->\hyperlink{classIOdata_ab0e3cd09f46c1c3712f797116f6da074}{dataU32}());
843     \textcolor{keywordflow}{break};
844   \textcolor{keywordflow}{default}:
845     \hyperlink{classObject_a204a95f57818c0f811933917a30eff45}{error}(\textcolor{stringliteral}{"Wrong word size."},\textcolor{stringliteral}{"UsbFTMLInterface::read"});
846     status=\hyperlink{classStatusCode_a6f565cbeadc76d14c72f047e5e85eb4ba3da73d4c469762eb9d3c960368252b26}{StatusCode::FAILURE};
847   \}
848   \textcolor{keywordflow}{return} status;
849 \}
\end{DoxyCode}
