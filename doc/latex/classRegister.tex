...
{\ttfamily \#include $<$inc/Register.h$>$}Inheritance diagram for Register::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=6cm]{classRegister}
\end{center}
\end{figure}
...
\hyperlink{classStatusCode}{StatusCode} \hyperlink{classRegister_ab094246dd12aa7e0aa0ca917f4e70b31}{setBit} (unsigned int, bool)
\item 
bool \hyperlink{classRegister_a5d27c9ff548817eee097ba4fdc8e8f69}{getBit} (unsigned int)
\item 
...
\item[Enumerator: ]\par
\begin{description}
\index{UNDEFINED@{UNDEFINED}!Register@{Register}}\index{Register@{Register}!UNDEFINED@{UNDEFINED}}\item[{\em 
...
}]\index{PASSIVE@{PASSIVE}!Register@{Register}}\index{Register@{Register}!PASSIVE@{PASSIVE}}\item[{\em 
...
}]\index{ACTIVE@{ACTIVE}!Register@{Register}}\index{Register@{Register}!ACTIVE@{ACTIVE}}\item[{\em 
...
}]\index{INTERFACE@{INTERFACE}!Register@{Register}}\index{Register@{Register}!INTERFACE@{INTERFACE}}\item[{\em 
...
}]\index{IO@{IO}!Register@{Register}}\index{Register@{Register}!IO@{IO}}\item[{\em 
...
}]\index{IODATA@{IODATA}!Register@{Register}}\index{Register@{Register}!IODATA@{IODATA}}\item[{\em 
...
}]\index{ELEMENT@{ELEMENT}!Register@{Register}}\index{Register@{Register}!ELEMENT@{ELEMENT}}\item[{\em 
...
}]\index{HARDWARE@{HARDWARE}!Register@{Register}}\index{Register@{Register}!HARDWARE@{HARDWARE}}\item[{\em 
...
}]\index{PROCESSUS@{PROCESSUS}!Register@{Register}}\index{Register@{Register}!PROCESSUS@{PROCESSUS}}\item[{\em 
...
}]\index{SOFTWARE@{SOFTWARE}!Register@{Register}}\index{Register@{Register}!SOFTWARE@{SOFTWARE}}\item[{\em 
...
21 }
\end{DoxyCode}
\hypertarget{classRegister_a27490bda19cd4bd6ca09b48a795fc060}{
\index{Register@{Register}!$\sim$Register@{$\sim$Register}}
\index{$\sim$Register@{$\sim$Register}!Register@{Register}}
\subsubsection[{$\sim$Register}]{\setlength{\rightskip}{0pt plus 5cm}Register::$\sim$Register ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classRegister_a27490bda19cd4bd6ca09b48a795fc060}
...
\index{Register@{Register}!addChild@{addChild}}
\index{addChild@{addChild}!Register@{Register}}
...
\index{Register@{Register}!childTyped@{childTyped}}
\index{childTyped@{childTyped}!Register@{Register}}
...
\index{Register@{Register}!delChild@{delChild}}
\index{delChild@{delChild}!Register@{Register}}
...
\index{Register@{Register}!dllName@{dllName}}
\index{dllName@{dllName}!Register@{Register}}
...
\end{DoxyCode}
\hypertarget{classRegister_a5d27c9ff548817eee097ba4fdc8e8f69}{
\index{Register@{Register}!getBit@{getBit}}
\index{getBit@{getBit}!Register@{Register}}
\subsubsection[{getBit}]{\setlength{\rightskip}{0pt plus 5cm}bool Register::getBit (unsigned int {\em bit})}}
\label{classRegister_a5d27c9ff548817eee097ba4fdc8e8f69}
...
Referenced by BOOST\_\-PYTHON\_\-MODULE(), A3PE::dataReady(), A3PE::enableADC(), A3PE::internalAXSequence(), A3PE::readPatternFifoUsb(), A3PE::readToAXRamUsb(), A3PE::readTriggerFifoUsb(), A3PE::softwareTrigger(), A3PE::writeFromAXRamUsb(), and A3PE::writeStorageFifoUsb().
...
\index{Register@{Register}!hasChildren@{hasChildren}}
\index{hasChildren@{hasChildren}!Register@{Register}}
...
\subsubsection[{help}]{\setlength{\rightskip}{0pt plus 5cm}void IOobject::help ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual, inherited\mbox{]}}}}
...
\index{Register@{Register}!msgSvc@{msgSvc}}
\index{msgSvc@{msgSvc}!Register@{Register}}
...
\index{Register@{Register}!numberOfChildren@{numberOfChildren}}
\index{numberOfChildren@{numberOfChildren}!Register@{Register}}
...
\index{Register@{Register}!pathTyped@{pathTyped}}
\index{pathTyped@{pathTyped}!Register@{Register}}
...
\index{Register@{Register}!recursiveInitCommunications@{recursiveInitCommunications}}
\index{recursiveInitCommunications@{recursiveInitCommunications}!Register@{Register}}
...
\index{Register@{Register}!recursiveInitElement@{recursiveInitElement}}
\index{recursiveInitElement@{recursiveInitElement}!Register@{Register}}
...
\index{Register@{Register}!setAddress@{setAddress}}
\index{setAddress@{setAddress}!Register@{Register}}
...
86   }
\end{DoxyCode}
\hypertarget{classRegister_ab094246dd12aa7e0aa0ca917f4e70b31}{
\index{Register@{Register}!setBit@{setBit}}
\index{setBit@{setBit}!Register@{Register}}
\subsubsection[{setBit}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} Register::setBit (unsigned int {\em bit}, \/  bool {\em val})}}
\label{classRegister_ab094246dd12aa7e0aa0ca917f4e70b31}
...
\index{Register@{Register}!setConnection@{setConnection}}
\index{setConnection@{setConnection}!Register@{Register}}
...
\index{Register@{Register}!setDllName@{setDllName}}
\index{setDllName@{setDllName}!Register@{Register}}
...
\index{Register@{Register}!setId@{setId}}
\index{setId@{setId}!Register@{Register}}
...
\index{Register@{Register}!setName@{setName}}
\index{setName@{setName}!Register@{Register}}
...
Referenced by A3PE::A3PE(), A3PE\_\-BitFlip::A3PE\_\-BitFlip(), Acquisition::Acquisition(), ADCMeasurement::ADCMeasurement(), Computer::Computer(), Application::create(), Croc::Croc(), CU\_\-v1::CU\_\-v1(), CurrentMeasurement::CurrentMeasurement(), EmulateFE::EmulateFE(), export\_\-obj(), FEB\_\-v1::FEB\_\-v1(), FePGA::FePGA(), ICECALv3::ICECALv3(), ICPhaser::ICPhaser(), Application::initialize(), Interface::Interface(), IOdata::IOdata(), IOobject::IOobject(), LSDelayChipV1::LSDelayChipV1(), FePGA::MakeRAM(), FePGA::MakeRegister(), Application::network(), NI6008::NI6008(), Object::Object(), PhaserRampExec::PhaserRampExec(), Proto40MHz\_\-v1::Proto40MHz\_\-v1(), RAM::RAM(), Register(), RegisterTest::RegisterTest(), SeqPGA::SeqPGA(), SpecsBus::SpecsBus(), SpecsGlue::SpecsGlue(), SpecsI2c::SpecsI2c(), SpecsMaster::SpecsMaster(), SpecsMezzanine::SpecsMezzanine(), SpecsParallelBus::SpecsParallelBus(), StorageFifo::StorageFifo(), StorageFifoAcquisition::StorageFifoAcquisition(), TestI2C::TestI2C(), TestSPI::TestSPI(), TestSuite::TestSuite(), TestUSB::TestUSB(), UsbFTInterface::UsbFTInterface(), UsbFTInterfaceTest::UsbFTInterfaceTest(), UsbFTMLInterface::UsbFTMLInterface(), UsbI2cBus::UsbI2cBus(), UsbMLI2cBus::UsbMLI2cBus(), UsbMLSpiBus::UsbMLSpiBus(), and UsbSpiBus::UsbSpiBus().
...
\index{Register@{Register}!setParent@{setParent}}
\index{setParent@{setParent}!Register@{Register}}
...
\index{Register@{Register}!setTitle@{setTitle}}
\index{setTitle@{setTitle}!Register@{Register}}
...
\index{Register@{Register}!setType@{setType}}
\index{setType@{setType}!Register@{Register}}
...
Referenced by A3PE::A3PE(), A3PE\_\-BitFlip::A3PE\_\-BitFlip(), Acquisition::Acquisition(), ADCMeasurement::ADCMeasurement(), Computer::Computer(), Croc::Croc(), CU\_\-v1::CU\_\-v1(), CurrentMeasurement::CurrentMeasurement(), DCU::DCU(), EmulateFE::EmulateFE(), export\_\-obj(), FEB\_\-v1::FEB\_\-v1(), FePGA::FePGA(), ICECALv3::ICECALv3(), ICPhaser::ICPhaser(), Application::initialize(), Interface::Interface(), IOdata::IOdata(), IOobject::IOobject(), LSDelayChipV1::LSDelayChipV1(), MSOxxxx::MSOxxxx(), NI6008::NI6008(), Object::Object(), Phaser::Phaser(), PhaserRampExec::PhaserRampExec(), Proto40MHz\_\-v1::Proto40MHz\_\-v1(), RAM::RAM(), Register(), RegisterTest::RegisterTest(), SeqPGA::SeqPGA(), SpecsBus::SpecsBus(), SpecsGlue::SpecsGlue(), SpecsI2c::SpecsI2c(), SpecsMaster::SpecsMaster(), SpecsMezzanine::SpecsMezzanine(), SpecsParallelBus::SpecsParallelBus(), SpecsSlave::SpecsSlave(), StorageFifo::StorageFifo(), StorageFifoAcquisition::StorageFifoAcquisition(), TestI2C::TestI2C(), TestSPI::TestSPI(), TestSuite::TestSuite(), TestUSB::TestUSB(), UsbFTInterface::UsbFTInterface(), UsbFTInterfaceTest::UsbFTInterfaceTest(), UsbFTMLInterface::UsbFTMLInterface(), UsbI2cBus::UsbI2cBus(), UsbMLI2cBus::UsbMLI2cBus(), UsbMLSpiBus::UsbMLSpiBus(), and UsbSpiBus::UsbSpiBus().
...
Referenced by BOOST\_\-PYTHON\_\-MODULE(), LSDelayChipV1::configRegBulkWrite(), A3PE::enableStorage(), TestUSB::execute(), getBit(), SeqPGA::i2cRead(), FePGA::i2cRead(), SeqPGA::i2cWrite(), FePGA::i2cWrite(), A3PE::loadFromAX(), A3PE::loadPattern(), A3PE::loadStorage(), A3PE::loadToAX(), A3PE::loadTrigger(), A3PE\_\-BitFlip::randomValues(), RAM::raz(), ICPhaser::reset(), SeqPGA::reset(), FePGA::reset(), A3PE::reset(), SeqPGA::resetSpi(), FePGA::resetUsb(), A3PE::setAddFromAXRam(), A3PE::setAddToAXRam(), setBit(), A3PE::setClockDivision(), SeqPGA::setExtTrig(), A3PE::setFifoDepth(), A3PE::setFifoLatency(), SeqPGA::setI2cAdd(), FePGA::setI2cAdd(), SeqPGA::setI2cGBTSCA(), FePGA::setI2cGBTSCA(), A3PE::setLatencyAX(), SeqPGA::setLedEnable(), A3PE::setLengthAX(), A3PE::setNTrigger(), A3PE::setPipeline(), SeqPGA::setSpiAdd(), FePGA::setSpiAdd(), SeqPGA::setSpiEnable(), SeqPGA::setSpiGBTSCA(), FePGA::setSpiGBTSCA(), A3PE::setTriggerDelay(), A3PE::setTriggerRate(), SeqPGA::spiRead(), FePGA::spiRead(), SeqPGA::spiWrite(), FePGA::spiWrite(), ICECALv3::spiWrite(), SeqPGA::testSequence(), FePGA::testSequence(), SeqPGA::transmitSpi(), FePGA::transmitSpi(), ICPhaser::write(), and Phaser::write().
...
\index{Register@{Register}!m\_\-attribString@{m\_\-attribString}}
\index{m\_\-attribString@{m\_\-attribString}!Register@{Register}}
...
\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatCore/inc/\hyperlink{Register_8h}{Register.h}\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatCore/src/\hyperlink{Register_8cpp}{Register.cpp}\end{DoxyCompactItemize}
