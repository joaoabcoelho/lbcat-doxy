\hypertarget{classPhaserRampExec}{
\section{PhaserRampExec Class Reference}
\label{classPhaserRampExec}\index{PhaserRampExec@{PhaserRampExec}}
}


{\ttfamily \#include $<$include/PhaserRampExec.h$>$}Inheritance diagram for PhaserRampExec::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=4cm]{classPhaserRampExec}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classPhaserRampExec_a26f14f1c66dd37251374998ae0a4f02a}{PhaserRampExec} ()
\begin{DoxyCompactList}\small\item\em Standard constructor. \item\end{DoxyCompactList}\item 
virtual \hyperlink{classPhaserRampExec_a0ea95adf577ff47f09068a20329f1598}{$\sim$PhaserRampExec} ()
\begin{DoxyCompactList}\small\item\em Destructor. \item\end{DoxyCompactList}\item 
virtual \hyperlink{classStatusCode}{StatusCode} \hyperlink{classPhaserRampExec_ae6f90f2ecf4b66d6f9bc85b123587ef3}{initialize} ()
\item 
virtual \hyperlink{classStatusCode}{StatusCode} \hyperlink{classPhaserRampExec_a5fccbd3cddf738318f9d45d64b723907}{execute} ()
\item 
virtual \hyperlink{classStatusCode}{StatusCode} \hyperlink{classPhaserRampExec_a8849cacdd34e7ca56f6d5e7668fe8c6c}{finalize} ()
\item 
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classPhaserRampExec}{PhaserRampExec} $\ast$ \hyperlink{classPhaserRampExec_a2586b2209d381c5b82a13dc2f997925f}{clone} ()
\end{DoxyCompactItemize}
...
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_a8c13c96564df17be4e71685684e67edd}{h1}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_a538d1b02ed14d13c71f54b2b48e765ba}{h2}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_ad9ec4185f676732648c4886f28c9c6b7}{h3}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_aa487df389ad66093dba562f27f558128}{h4}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_ad2a2a82a0be74bc39c84b580e33d9c34}{hv1}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_a9762fd546432b5f3dffc4c5323af56ac}{hv2}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_ad3127f38a360044f7ad8fed272f916f9}{hv3}
\item 
TH1D $\ast$ \hyperlink{classPhaserRampExec_a998b7e5a8d186df60c2d60cba2b43aa0}{hv4}
\item 
TFile $\ast$ \hyperlink{classPhaserRampExec_a63092bcbec01af94b4c5c842b81d2ccf}{file}
\item 
TH1F $\ast$ \hyperlink{classPhaserRampExec_a0c8d1c3ee09159cba1b1a07ce3fb1d96}{histo}
\item 
int \hyperlink{classPhaserRampExec_a7526a42abb33e880d60570386fd23e3e}{m\_\-initPhase} \mbox{[}4\mbox{]}
\item 
unsigned long \hyperlink{classPhaserRampExec_a198ba1ebb9a1b0fb2c599405307e92af}{m\_\-nProcessedEvents}
\item 
unsigned long \hyperlink{classPhaserRampExec_a3f09b8bf4cd8f5425adf8ae168d39e50}{errorCount}
\end{DoxyCompactItemize}
...
\index{PhaserRampExec@{PhaserRampExec}!Attribut@{Attribut}}
\index{Attribut@{Attribut}!PhaserRampExec@{PhaserRampExec}}
...
\item[Enumerator: ]\par
\begin{description}
\index{UNDEFINED@{UNDEFINED}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!UNDEFINED@{UNDEFINED}}\item[{\em 
...
}]\index{PASSIVE@{PASSIVE}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!PASSIVE@{PASSIVE}}\item[{\em 
...
}]\index{ACTIVE@{ACTIVE}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!ACTIVE@{ACTIVE}}\item[{\em 
...
}]\index{INTERFACE@{INTERFACE}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!INTERFACE@{INTERFACE}}\item[{\em 
...
}]\index{IO@{IO}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!IO@{IO}}\item[{\em 
...
}]\index{IODATA@{IODATA}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!IODATA@{IODATA}}\item[{\em 
...
}]\index{ELEMENT@{ELEMENT}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!ELEMENT@{ELEMENT}}\item[{\em 
...
}]\index{HARDWARE@{HARDWARE}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!HARDWARE@{HARDWARE}}\item[{\em 
...
}]\index{PROCESSUS@{PROCESSUS}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!PROCESSUS@{PROCESSUS}}\item[{\em 
...
}]\index{SOFTWARE@{SOFTWARE}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!SOFTWARE@{SOFTWARE}}\item[{\em 
...
\index{PhaserRampExec@{PhaserRampExec}!states@{states}}
\index{states@{states}!PhaserRampExec@{PhaserRampExec}}
...
\item[Enumerator: ]\par
\begin{description}
\index{ERR@{ERR}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!ERR@{ERR}}\item[{\em 
...
}]\index{NOT\_\-OK@{NOT\_\-OK}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!NOT\_\-OK@{NOT\_\-OK}}\item[{\em 
...
}]\index{OK@{OK}!PhaserRampExec@{PhaserRampExec}}\index{PhaserRampExec@{PhaserRampExec}!OK@{OK}}\item[{\em 
...
\hypertarget{classPhaserRampExec_a26f14f1c66dd37251374998ae0a4f02a}{
\index{PhaserRampExec@{PhaserRampExec}!PhaserRampExec@{PhaserRampExec}}
\index{PhaserRampExec@{PhaserRampExec}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{PhaserRampExec}]{\setlength{\rightskip}{0pt plus 5cm}PhaserRampExec::PhaserRampExec ()}}
\label{classPhaserRampExec_a26f14f1c66dd37251374998ae0a4f02a}
...
40 }
\end{DoxyCode}
\hypertarget{classPhaserRampExec_a0ea95adf577ff47f09068a20329f1598}{
\index{PhaserRampExec@{PhaserRampExec}!$\sim$PhaserRampExec@{$\sim$PhaserRampExec}}
\index{$\sim$PhaserRampExec@{$\sim$PhaserRampExec}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{$\sim$PhaserRampExec}]{\setlength{\rightskip}{0pt plus 5cm}PhaserRampExec::$\sim$PhaserRampExec ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classPhaserRampExec_a0ea95adf577ff47f09068a20329f1598}
...
\index{PhaserRampExec@{PhaserRampExec}!add@{add}}
\index{add@{add}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!addDataStream@{addDataStream}}
\index{addDataStream@{addDataStream}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!addHisto1d@{addHisto1d}}
\index{addHisto1d@{addHisto1d}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!addHisto2d@{addHisto2d}}
\index{addHisto2d@{addHisto2d}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!attributs@{attributs}}
\index{attributs@{attributs}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!clean@{clean}}
\index{clean@{clean}!PhaserRampExec@{PhaserRampExec}}
...
99   }
\end{DoxyCode}
\hypertarget{classPhaserRampExec_a2586b2209d381c5b82a13dc2f997925f}{
\index{PhaserRampExec@{PhaserRampExec}!clone@{clone}}
\index{clone@{clone}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{clone}]{\setlength{\rightskip}{0pt plus 5cm}{\bf PhaserRampExec}$\ast$ PhaserRampExec::clone ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, protected, virtual\mbox{]}}}}
\label{classPhaserRampExec_a2586b2209d381c5b82a13dc2f997925f}
...
\index{PhaserRampExec@{PhaserRampExec}!closeRootFile@{closeRootFile}}
\index{closeRootFile@{closeRootFile}!PhaserRampExec@{PhaserRampExec}}
...
Referenced by Processus::endProcessing(), UsbFTInterfaceTest::finalize(), RegisterTest::finalize(), and finalize().
...
\index{PhaserRampExec@{PhaserRampExec}!data@{data}}
\index{data@{data}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!dataFill@{dataFill}}
\index{dataFill@{dataFill}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!debug@{debug}}
\index{debug@{debug}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!dllName@{dllName}}
\index{dllName@{dllName}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!elapsedTime@{elapsedTime}}
\index{elapsedTime@{elapsedTime}!PhaserRampExec@{PhaserRampExec}}
...
Referenced by Processus::endProcessing(), UsbFTInterfaceTest::execute(), finalize(), and Processus::setState().
...
\index{PhaserRampExec@{PhaserRampExec}!element@{element}}
\index{element@{element}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!endProcessing@{endProcessing}}
\index{endProcessing@{endProcessing}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!error@{error}}
\index{error@{error}!PhaserRampExec@{PhaserRampExec}}
...
\end{DoxyCode}
\hypertarget{classPhaserRampExec_a5fccbd3cddf738318f9d45d64b723907}{
\index{PhaserRampExec@{PhaserRampExec}!execute@{execute}}
\index{execute@{execute}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{execute}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} PhaserRampExec::execute ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classPhaserRampExec_a5fccbd3cddf738318f9d45d64b723907}
...
References errorCount, h1, h2, h3, h4, hv1, hv2, hv3, hv4, Object::info(), itos(), m\_\-nProcessedEvents, m\_\-phaser, Phaser::phase(), Phaser::read(), Phaser::setPhase(), StatusCode::SUCCESS, and Phaser::write().
...
\index{PhaserRampExec@{PhaserRampExec}!fatal@{fatal}}
\index{fatal@{fatal}!PhaserRampExec@{PhaserRampExec}}
...
\end{DoxyCode}
\hypertarget{classPhaserRampExec_a8849cacdd34e7ca56f6d5e7668fe8c6c}{
\index{PhaserRampExec@{PhaserRampExec}!finalize@{finalize}}
\index{finalize@{finalize}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{finalize}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} PhaserRampExec::finalize ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{classPhaserRampExec_a8849cacdd34e7ca56f6d5e7668fe8c6c}
processus termination virtual function 
...
References Processus::closeRootFile(), Processus::elapsedTime(), errorCount, ftos(), h1, h2, h3, h4, hv1, hv2, hv3, hv4, Object::info(), itos(), m\_\-initPhase, m\_\-nProcessedEvents, m\_\-phaser, Phaser::setPhase(), StatusCode::SUCCESS, and Phaser::write().
...
144   info("****************************" );
145  
146   m_phaser->setPhase(m_initPhase[0],
147                      m_initPhase[1],
148                      m_initPhase[2],
149                      m_initPhase[3]);
150   
...
\index{PhaserRampExec@{PhaserRampExec}!hist1d@{hist1d}}
\index{hist1d@{hist1d}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!hist2d@{hist2d}}
\index{hist2d@{hist2d}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!id@{id}}
\index{id@{id}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!incNErrors@{incNErrors}}
\index{incNErrors@{incNErrors}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!info@{info}}
\index{info@{info}!PhaserRampExec@{PhaserRampExec}}
...
References Processus::element(), errorCount, h1, h2, h3, h4, hv1, hv2, hv3, hv4, Object::info(), m\_\-initPhase, m\_\-nProcessedEvents, m\_\-phaser, Object::name(), Processus::openRootFile(), Phaser::phase(), Phaser::read(), Processus::startChrono(), StatusCode::SUCCESS, and Object::type().
...
\index{PhaserRampExec@{PhaserRampExec}!is@{is}}
\index{is@{is}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!logMsg@{logMsg}}
\index{logMsg@{logMsg}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!msg@{msg}}
\index{msg@{msg}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!msgSvc@{msgSvc}}
\index{msgSvc@{msgSvc}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!name@{name}}
\index{name@{name}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!nErrors@{nErrors}}
\index{nErrors@{nErrors}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!openRootFile@{openRootFile}}
\index{openRootFile@{openRootFile}!PhaserRampExec@{PhaserRampExec}}
...
Referenced by UsbFTInterfaceTest::initialize(), RegisterTest::initialize(), initialize(), and Processus::startProcessing().
...
\index{PhaserRampExec@{PhaserRampExec}!remove@{remove}}
\index{remove@{remove}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!rootFile@{rootFile}}
\index{rootFile@{rootFile}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setDllName@{setDllName}}
\index{setDllName@{setDllName}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setElement@{setElement}}
\index{setElement@{setElement}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setId@{setId}}
\index{setId@{setId}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setLogMsg@{setLogMsg}}
\index{setLogMsg@{setLogMsg}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setName@{setName}}
\index{setName@{setName}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setNErrors@{setNErrors}}
\index{setNErrors@{setNErrors}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setState@{setState}}
\index{setState@{setState}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setStorage@{setStorage}}
\index{setStorage@{setStorage}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!setTitle@{setTitle}}
\index{setTitle@{setTitle}!PhaserRampExec@{PhaserRampExec}}
...
Referenced by A3PE\_\-BitFlip::A3PE\_\-BitFlip(), Acquisition::Acquisition(), ADCMeasurement::ADCMeasurement(), CurrentMeasurement::CurrentMeasurement(), EmulateFE::EmulateFE(), export\_\-obj(), Histo1D::Histo1D(), Histo2D::Histo2D(), Object::Object(), PhaserRampExec(), RegisterTest::RegisterTest(), StorageFifo::StorageFifo(), StorageFifoAcquisition::StorageFifoAcquisition(), TestI2C::TestI2C(), TestSPI::TestSPI(), TestSuite::TestSuite(), TestUSB::TestUSB(), and UsbFTInterfaceTest::UsbFTInterfaceTest().
...
\index{PhaserRampExec@{PhaserRampExec}!setType@{setType}}
\index{setType@{setType}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!startChrono@{startChrono}}
\index{startChrono@{startChrono}!PhaserRampExec@{PhaserRampExec}}
...
Referenced by initialize(), and Processus::startProcessing().
...
\index{PhaserRampExec@{PhaserRampExec}!startProcessing@{startProcessing}}
\index{startProcessing@{startProcessing}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!storage@{storage}}
\index{storage@{storage}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!title@{title}}
\index{title@{title}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!type@{type}}
\index{type@{type}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!verbose@{verbose}}
\index{verbose@{verbose}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!warning@{warning}}
\index{warning@{warning}!PhaserRampExec@{PhaserRampExec}}
...
\hypertarget{classPhaserRampExec_a3f09b8bf4cd8f5425adf8ae168d39e50}{
\index{PhaserRampExec@{PhaserRampExec}!errorCount@{errorCount}}
\index{errorCount@{errorCount}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{errorCount}]{\setlength{\rightskip}{0pt plus 5cm}unsigned long {\bf PhaserRampExec::errorCount}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a3f09b8bf4cd8f5425adf8ae168d39e50}


Definition at line 56 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_a63092bcbec01af94b4c5c842b81d2ccf}{
\index{PhaserRampExec@{PhaserRampExec}!file@{file}}
\index{file@{file}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{file}]{\setlength{\rightskip}{0pt plus 5cm}TFile$\ast$ {\bf PhaserRampExec::file}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a63092bcbec01af94b4c5c842b81d2ccf}


Definition at line 50 of file PhaserRampExec.h.\hypertarget{classPhaserRampExec_a8c13c96564df17be4e71685684e67edd}{
\index{PhaserRampExec@{PhaserRampExec}!h1@{h1}}
\index{h1@{h1}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{h1}]{\setlength{\rightskip}{0pt plus 5cm}TH1D$\ast$ {\bf PhaserRampExec::h1}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a8c13c96564df17be4e71685684e67edd}


Definition at line 48 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_a538d1b02ed14d13c71f54b2b48e765ba}{
\index{PhaserRampExec@{PhaserRampExec}!h2@{h2}}
\index{h2@{h2}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{h2}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf PhaserRampExec::h2}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a538d1b02ed14d13c71f54b2b48e765ba}


Definition at line 48 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_ad9ec4185f676732648c4886f28c9c6b7}{
\index{PhaserRampExec@{PhaserRampExec}!h3@{h3}}
\index{h3@{h3}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{h3}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf PhaserRampExec::h3}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_ad9ec4185f676732648c4886f28c9c6b7}


Definition at line 48 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_aa487df389ad66093dba562f27f558128}{
\index{PhaserRampExec@{PhaserRampExec}!h4@{h4}}
\index{h4@{h4}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{h4}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf PhaserRampExec::h4}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_aa487df389ad66093dba562f27f558128}


Definition at line 48 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_a0c8d1c3ee09159cba1b1a07ce3fb1d96}{
\index{PhaserRampExec@{PhaserRampExec}!histo@{histo}}
\index{histo@{histo}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{histo}]{\setlength{\rightskip}{0pt plus 5cm}TH1F$\ast$ {\bf PhaserRampExec::histo}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a0c8d1c3ee09159cba1b1a07ce3fb1d96}


Definition at line 51 of file PhaserRampExec.h.\hypertarget{classPhaserRampExec_ad2a2a82a0be74bc39c84b580e33d9c34}{
\index{PhaserRampExec@{PhaserRampExec}!hv1@{hv1}}
\index{hv1@{hv1}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{hv1}]{\setlength{\rightskip}{0pt plus 5cm}TH1D$\ast$ {\bf PhaserRampExec::hv1}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_ad2a2a82a0be74bc39c84b580e33d9c34}


Definition at line 49 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_a9762fd546432b5f3dffc4c5323af56ac}{
\index{PhaserRampExec@{PhaserRampExec}!hv2@{hv2}}
\index{hv2@{hv2}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{hv2}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf PhaserRampExec::hv2}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a9762fd546432b5f3dffc4c5323af56ac}


Definition at line 49 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_ad3127f38a360044f7ad8fed272f916f9}{
\index{PhaserRampExec@{PhaserRampExec}!hv3@{hv3}}
\index{hv3@{hv3}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{hv3}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf PhaserRampExec::hv3}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_ad3127f38a360044f7ad8fed272f916f9}


Definition at line 49 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_a998b7e5a8d186df60c2d60cba2b43aa0}{
\index{PhaserRampExec@{PhaserRampExec}!hv4@{hv4}}
\index{hv4@{hv4}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{hv4}]{\setlength{\rightskip}{0pt plus 5cm}TH1D $\ast$ {\bf PhaserRampExec::hv4}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a998b7e5a8d186df60c2d60cba2b43aa0}


Definition at line 49 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classAttrib_a3414521d7a82476e874b25a5407b5e63}{
\index{PhaserRampExec@{PhaserRampExec}!m\_\-attribString@{m\_\-attribString}}
\index{m\_\-attribString@{m\_\-attribString}!PhaserRampExec@{PhaserRampExec}}
...
\index{PhaserRampExec@{PhaserRampExec}!m\_\-element@{m\_\-element}}
\index{m\_\-element@{m\_\-element}!PhaserRampExec@{PhaserRampExec}}
...
Referenced by Processus::clean(), Processus::element(), Processus::setElement(), and Processus::$\sim$Processus().\hypertarget{classPhaserRampExec_a7526a42abb33e880d60570386fd23e3e}{
\index{PhaserRampExec@{PhaserRampExec}!m\_\-initPhase@{m\_\-initPhase}}
\index{m\_\-initPhase@{m\_\-initPhase}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{m\_\-initPhase}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf PhaserRampExec::m\_\-initPhase}\mbox{[}4\mbox{]}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a7526a42abb33e880d60570386fd23e3e}


Definition at line 53 of file PhaserRampExec.h.

Referenced by finalize(), and initialize().\hypertarget{classPhaserRampExec_a198ba1ebb9a1b0fb2c599405307e92af}{
\index{PhaserRampExec@{PhaserRampExec}!m\_\-nProcessedEvents@{m\_\-nProcessedEvents}}
\index{m\_\-nProcessedEvents@{m\_\-nProcessedEvents}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{m\_\-nProcessedEvents}]{\setlength{\rightskip}{0pt plus 5cm}unsigned long {\bf PhaserRampExec::m\_\-nProcessedEvents}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a198ba1ebb9a1b0fb2c599405307e92af}


Definition at line 55 of file PhaserRampExec.h.

Referenced by execute(), finalize(), and initialize().\hypertarget{classPhaserRampExec_a3c187e98596d492f195c2743322e263b}{
\index{PhaserRampExec@{PhaserRampExec}!m\_\-phaser@{m\_\-phaser}}
\index{m\_\-phaser@{m\_\-phaser}!PhaserRampExec@{PhaserRampExec}}
\subsubsection[{m\_\-phaser}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Phaser}$\ast$ {\bf PhaserRampExec::m\_\-phaser}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
\label{classPhaserRampExec_a3c187e98596d492f195c2743322e263b}
...
\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatCalo/inc/proc/\hyperlink{PhaserRampExec_8h}{PhaserRampExec.h}\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatCalo/src/proc/\hyperlink{PhaserRampExec_8cpp}{PhaserRampExec.cpp}\end{DoxyCompactItemize}
