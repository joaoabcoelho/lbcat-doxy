\hypertarget{structElementWrap}{
\section{ElementWrap Struct Reference}
\label{structElementWrap}\index{ElementWrap@{ElementWrap}}
}
Inheritance diagram for ElementWrap::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=5cm]{structElementWrap}
\end{center}
\end{figure}
...
\item 
\hyperlink{classStatusCode}{StatusCode} \hyperlink{structElementWrap_a5e0ca7bd04cfb1f7582fc80c065fd376}{init} ()
\item 
...
\index{ElementWrap@{ElementWrap}!Attribut@{Attribut}}
\index{Attribut@{Attribut}!ElementWrap@{ElementWrap}}
...
\item[Enumerator: ]\par
\begin{description}
\index{UNDEFINED@{UNDEFINED}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!UNDEFINED@{UNDEFINED}}\item[{\em 
...
}]\index{PASSIVE@{PASSIVE}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!PASSIVE@{PASSIVE}}\item[{\em 
...
}]\index{ACTIVE@{ACTIVE}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!ACTIVE@{ACTIVE}}\item[{\em 
...
}]\index{INTERFACE@{INTERFACE}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!INTERFACE@{INTERFACE}}\item[{\em 
...
}]\index{IO@{IO}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!IO@{IO}}\item[{\em 
...
}]\index{IODATA@{IODATA}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!IODATA@{IODATA}}\item[{\em 
...
}]\index{ELEMENT@{ELEMENT}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!ELEMENT@{ELEMENT}}\item[{\em 
...
}]\index{HARDWARE@{HARDWARE}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!HARDWARE@{HARDWARE}}\item[{\em 
...
}]\index{PROCESSUS@{PROCESSUS}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!PROCESSUS@{PROCESSUS}}\item[{\em 
...
}]\index{SOFTWARE@{SOFTWARE}!ElementWrap@{ElementWrap}}\index{ElementWrap@{ElementWrap}!SOFTWARE@{SOFTWARE}}\item[{\em 
...
\index{ElementWrap@{ElementWrap}!add@{add}}
\index{add@{add}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!addChild@{addChild}}
\index{addChild@{addChild}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!attributs@{attributs}}
\index{attributs@{attributs}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!child@{child}}
\index{child@{child}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!children@{children}}
\index{children@{children}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!childTyped@{childTyped}}
\index{childTyped@{childTyped}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!clear@{clear}}
\index{clear@{clear}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!connection@{connection}}
\index{connection@{connection}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!debug@{debug}}
\index{debug@{debug}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!delChild@{delChild}}
\index{delChild@{delChild}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!dllName@{dllName}}
\index{dllName@{dllName}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!error@{error}}
\index{error@{error}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!fatal@{fatal}}
\index{fatal@{fatal}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!hasChildren@{hasChildren}}
\index{hasChildren@{hasChildren}!ElementWrap@{ElementWrap}}
...
305 }
\end{DoxyCode}
\hypertarget{structElementWrap_ad22ed533c2dad73f8650243d8060b547}{
\index{ElementWrap@{ElementWrap}!help@{help}}
\index{help@{help}!ElementWrap@{ElementWrap}}
\subsubsection[{help}]{\setlength{\rightskip}{0pt plus 5cm}void ElementWrap::help ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
\label{structElementWrap_ad22ed533c2dad73f8650243d8060b547}
...
\begin{DoxyCode}
21 {this->get_override("help")();};
\end{DoxyCode}
\hypertarget{classObject_af99145335cc61ff6e2798ea17db009d2}{
\index{ElementWrap@{ElementWrap}!id@{id}}
\index{id@{id}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!info@{info}}
\index{info@{info}!ElementWrap@{ElementWrap}}
...
\end{DoxyCode}
\hypertarget{structElementWrap_a5e0ca7bd04cfb1f7582fc80c065fd376}{
\index{ElementWrap@{ElementWrap}!init@{init}}
\index{init@{init}!ElementWrap@{ElementWrap}}
\subsubsection[{init}]{\setlength{\rightskip}{0pt plus 5cm}{\bf StatusCode} ElementWrap::init ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
\label{structElementWrap_a5e0ca7bd04cfb1f7582fc80c065fd376}
init the component
...
\begin{DoxyCode}
22 {return this->get_override("init")();};
\end{DoxyCode}
\hypertarget{classAttrib_a704f26af560909ad22065083bb7d4c34}{
\index{ElementWrap@{ElementWrap}!is@{is}}
\index{is@{is}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!msg@{msg}}
\index{msg@{msg}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!msgSvc@{msgSvc}}
\index{msgSvc@{msgSvc}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!name@{name}}
\index{name@{name}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!numberOfChildren@{numberOfChildren}}
\index{numberOfChildren@{numberOfChildren}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!origin@{origin}}
\index{origin@{origin}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!parent@{parent}}
\index{parent@{parent}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!path@{path}}
\index{path@{path}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!pathTyped@{pathTyped}}
\index{pathTyped@{pathTyped}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!recursiveInitCommunications@{recursiveInitCommunications}}
\index{recursiveInitCommunications@{recursiveInitCommunications}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!recursiveInitElement@{recursiveInitElement}}
\index{recursiveInitElement@{recursiveInitElement}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!remove@{remove}}
\index{remove@{remove}!ElementWrap@{ElementWrap}}
...
97   }
\end{DoxyCode}
\hypertarget{structElementWrap_a69a4588be73b8c85ddb92b13f74c3a12}{
\index{ElementWrap@{ElementWrap}!reset@{reset}}
\index{reset@{reset}!ElementWrap@{ElementWrap}}
\subsubsection[{reset}]{\setlength{\rightskip}{0pt plus 5cm}void ElementWrap::reset ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
\label{structElementWrap_a69a4588be73b8c85ddb92b13f74c3a12}
...
\begin{DoxyCode}
23 {this->get_override("reset")();};
\end{DoxyCode}
\hypertarget{classElement_ab476b4b1df5954141ceb14f072433b89}{
\index{ElementWrap@{ElementWrap}!setConnection@{setConnection}}
\index{setConnection@{setConnection}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!setDllName@{setDllName}}
\index{setDllName@{setDllName}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!setId@{setId}}
\index{setId@{setId}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!setName@{setName}}
\index{setName@{setName}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!setParent@{setParent}}
\index{setParent@{setParent}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!setTitle@{setTitle}}
\index{setTitle@{setTitle}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!setType@{setType}}
\index{setType@{setType}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!title@{title}}
\index{title@{title}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!tree@{tree}}
\index{tree@{tree}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!type@{type}}
\index{type@{type}!ElementWrap@{ElementWrap}}
...
\end{DoxyCode}
\hypertarget{structElementWrap_a13d2d2771d1dd305abf3457f98482cbe}{
\index{ElementWrap@{ElementWrap}!update@{update}}
\index{update@{update}!ElementWrap@{ElementWrap}}
\subsubsection[{update}]{\setlength{\rightskip}{0pt plus 5cm}void ElementWrap::update ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
\label{structElementWrap_a13d2d2771d1dd305abf3457f98482cbe}
...
\begin{DoxyCode}
24 {this->get_override("update")();};
\end{DoxyCode}
\hypertarget{classObject_a2d4120195317e2a3c6532e8bb9f3da68}{
\index{ElementWrap@{ElementWrap}!verbose@{verbose}}
\index{verbose@{verbose}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!warning@{warning}}
\index{warning@{warning}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!m\_\-attribString@{m\_\-attribString}}
\index{m\_\-attribString@{m\_\-attribString}!ElementWrap@{ElementWrap}}
...
\index{ElementWrap@{ElementWrap}!m\_\-connection@{m\_\-connection}}
\index{m\_\-connection@{m\_\-connection}!ElementWrap@{ElementWrap}}
...
\item 
/home/eleclhcb/LHCb/lbcat-\/cmake/CatKernel/src/\hyperlink{Python__Obj_8cpp}{Python\_\-Obj.cpp}\end{DoxyCompactItemize}
